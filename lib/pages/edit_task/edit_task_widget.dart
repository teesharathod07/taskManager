...
class _EditTaskWidgetState extends State<EditTaskWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TasksRecord>(
      stream: TasksRecord.getDocument(widget!.taskId!),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(20.0, 15.0, 20.0, 6.0),
                      child: Container(
                        width: 370.0,
                        child: TextFormField(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: _model.descriptionTextController ??=
                              TextEditingController(
                            text: editTaskTasksRecord.description,
                          ),
                      ...
                      child: Container(
                        ...
                        child: FlutterFlowDropDown<String>(
                          controller: _model.dropDownValueController ??=
                            ...
                            _model.dropDownValue ??= editTaskTasksRecord.status,
                          ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            key: ValueKey(
                                editTaskTasksRecord.isImportant.toString()),
                          ...
                          Flexible(
                            child: Theme(
                              ...
                              child: Checkbox(
                                value: _model.isimportantValue ??= true,
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await editTaskTasksRecord.reference
                                    ...
                                    isImportant: _model.isimportantValue,
                                    description:
